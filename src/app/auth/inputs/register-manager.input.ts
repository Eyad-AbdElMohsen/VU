...
import { IsEmail, IsEnum, IsNotEmpty, IsOptional, IsPhoneNumber, IsString, IsUrl, Length, Matches, ValidateNested } from "class-validator";
...
export class RegisterUserInput {
  ...
  @IsString()
  @IsNotEmpty()
  @Length(8, 20, { message: "Confirm Password must between 8 and 20 characters" })
  @Matches(/(?=.*[a-z])(?=.*[A-Z])/, {
    message: 'Confirm Password must contain at least one uppercase and one lowercase letter',
  })
